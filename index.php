...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="accesorios.php" class="list-group-item list-group-item-action">Accesorios para el entreno</a></li>
                    <li><a href="materiales.php" class="list-group-item list-group-item-action">Materiales deportivos</a></li>
                    <li><a href="entrenamiento.php" class="list-group-item list-group-item-action">Entrenamiento Funcional</a></li>
                    <li><a href="protecciones.php" class="list-group-item list-group-item-action">Protecciones deportivas</a></li>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        ...
                        ?>
                            <a class="nav-link fw-bold" href="cerrarSesion">Cerrar Sesion</a>

                        <?php

                        } else {
                        ?>
                            <a class="nav-link fw-bold" href="iniciarSesion">Iniciar Sesion</a>
                        <?php
                        }
                        ?>
                ...
                ?>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="imagenes/<?php echo $row['producto_foto'] ?>" alt="<?php echo $row['producto_nombre'] ?>" />
                            <!-- Product details-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="descripcionProducto.php?idProducto=<?php echo $row['producto_id'] ?>">Ver Descripcion</a></div>
                            </div>
                        </div>
                    </div>
                <?php
    ...
    <button class="btn btn-light position-relative top-50 start-50 translate-middle" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
    ¿Donde estamos?
  </button>
